...
gem 'chatterbox', '~> 0.8.5'
gem 'ruby-net-ldap', '0.0.4', :require => 'net/ldap'
gem 'clearance', '0.8.8'
gem 'chronic', '0.2.3' # Not sure what needs it yet, but it is definitely a project dependency
gem 'ezcrypto', '0.7.2'
...
group "test" do
  ...
  gem 'the_metric_system', '2.3.6', :require => false 
  gem 'sexp_processor', '3.0.3'
  gem 'ruby_parser', '2.0.4'
  gem 'rcov', '0.9.8', :require => false
